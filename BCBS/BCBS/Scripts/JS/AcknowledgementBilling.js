...
$(document).ready(function () {
    ...
    $(document).on("click", ".addProjectService", function () {
        ...
        var projectin = addServiceinProject.split("_")[1];
        debugger;
        $("#tblProject_" + projectin + "_" + projectId).find(".parentServiceDiv").each(function (i, data) {
            $("#Service").find("Option").each(function (optionindex, optiondata) {
                if ($(optiondata).val() == $(data).find("input:hidden").last().val() && $(data).is(":hidden") != true) {
                    $(optiondata).attr("disabled", "disaabled");
                }
            });
            $("#Service").multiselect("clearSelection");
...
function GenereateProjectTemplate(projectData) {
    ...
    if (projectData.length > 0) {
        ...
        for (var i = 0 ; i < projectData.length; i++) {
            //var serviceFeesTypeData = projectData.filter(function (el) { if (el.FeesType == selectedFeesType[i]) { return el }; });
            ...
            if (projectData[i].FeesType == "Transaction") {
                    ...
                    str += "<td>$" + kendo.toString(projectData[i].Budget, "n") + "  /<span class='ServiceFeesType " + projectData[i].ServiceId + "' id='ServiceFeesType_" + projectData[i].ServiceId + "'>" + projectData[i].FeesType + "</span></td>";
            ...
            "<input id='Projects_" + currentProjectIndex + "__Services_" + i + "__Budget' name='Projects[" + currentProjectIndex + "].Services[" + i + "].Budget' type='hidden' value='" + projectData[i].Amount + "'>" +
...
function AddProjectServiceTemplate(projectid, projectData) {
    ...
    var cnt = parseInt(lastserviceindex) + 1 + parseInt(projectData.length);
        ...
        for (var i = parseInt(lastserviceindex) + 1 ; i < cnt; i++) {
            ...
            if (projectData[j] == "Transaction") {
                ...
                if (projectData.length > 0) {
                    ...
                    str += "<td>$" + projectData[j].Budget + "  /<span class='ServiceFeesType " + projectData[j].ServiceId + "' id='ServiceFeesType_" + projectData[j].ServiceId + "'>" + projectData[j].FeesType + "</span></td>";
            ...
            //      "<td><span id='Service_" + projectIndex + "_" + i + "' class='glyphicon glyphicon-remove removeService'></span></td>"
            //"</tr>";
            str += "<input id='Projects_" + projectIndex + "__Services_" + i + "__Name' name='Projects[" + projectIndex + "].Services[" + i + "].Name' type='hidden' value='" + projectData[j].ServiceName + "'>" +
            "<input id='Projects_" + projectIndex + "__Services_" + i + "__FeesType' name='Projects[" + projectIndex + "].Services[" + i + "].FeesType' type='hidden' value='" + projectData[j].FeesType + "'>" +
            "<input id='Projects_" + projectIndex + "__Services_" + i + "__Budget' name='Projects[" + projectIndex + "].Services[" + i + "].Budget' type='hidden' value='" + projectData[j].Budget + "'>" +
            ...
            "<input id='Projects_" + projectIndex + "__Services_" + i + "__Id' name='Projects[" + projectIndex + "].Services[" + i + "].Id' type='hidden' value='" + projectData[j].ServiceId + "'>";
            j++;
        }
    }
